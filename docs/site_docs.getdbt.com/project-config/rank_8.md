...
Configurations and properties, what are they? | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/configs-and-properties.md)

Last updated on **Nov 19, 2025**

[Previous

About resource paths](/reference/resource-configs/resource-path)[Next
