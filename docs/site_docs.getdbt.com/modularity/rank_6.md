# Source: https://docs.getdbt.com/blog/train-linear-dbt-bigframes

How to train a linear regression model with dbt and BigFrames | dbt Developer Blog
...
[dbt Docs](/ "dbt Docs")[Developer Blog](/blog "Blog")[How to train a linear regression model with dbt and BigFrames](# "How to train a linear regression model with dbt and BigFrames")
...
The power of dbt-BigFrames for large-scale linear regression[​](#the-power-of-dbt-bigframes-for-large-scale-linear-regression "Direct link to The power of dbt-BigFrames for large-scale linear regression")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
“dbt-BigFrames” with ML: A practical example[​](#dbt-bigframes-with-ml-a-practical-example "Direct link to “dbt-BigFrames” with ML: A practical example")
---------------------------------------------------------------------------------------------------------------------------------------------------------
...
Setting up your dbt project for BigFrames[​](#setting-up-your-dbt-project-for-bigframes "Direct link to Setting up your dbt project for BigFrames")
---------------------------------------------------------------------------------------------------------------------------------------------------
...
### Sample `profiles.yml` for BigFrames[​](#sample-profilesyml-for-bigframes "Direct link to sample-profilesyml-for-bigframes")
...
### Sample `dbt_project.yml`[​](#sample-dbt_projectyml "Direct link to sample-dbt_projectyml")
...
The dbt Python models for linear regression[​](#the-dbt-python-models-for-linear-regression "Direct link to The dbt Python models for linear regression")
---------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Part 1: Preparing the table (`prepare_table.py`)[​](#part-1-preparing-the-table-prepare_tablepy "Direct link to part-1-preparing-the-table-prepare_tablepy")
...
### Part 2: Training the model and making predictions (`prediction.py`)[​](#part-2-training-the-model-and-making-predictions-predictionpy "Direct link to part-2-training-the-model-and-making-predictions-predictionpy")
...
Running your dbt ML pipeline[​](#running-your-dbt-ml-pipeline "Direct link to Running your dbt ML pipeline")
------------------------------------------------------------------------------------------------------------
...
Key advantages of dbt and BigFrames for ML[​](#key-advantages-of-dbt-and-bigframes-for-ml "Direct link to Key advantages of dbt and BigFrames for ML")
------------------------------------------------------------------------------------------------------------------------------------------------------
...
Building the Remote dbt MCP Server](/blog/building-the-remote-dbt-mcp-server)[Older post

The new dbt VS Code extension: The experience we've all been waiting for](/blog/vscode-extension-experience)

* [Introduction to dbt and BigFrames](#introduction-to-dbt-and-bigframes)
* [The power of dbt-BigFrames for large-scale linear regression](#the-power-of-dbt-bigframes-for-large-scale-linear-regression)
* [“dbt-BigFrames” with ML: A practical example](#dbt-bigframes-with-ml-a-practical-example)
  + [Problem statement](#problem-statement)
* [Setting up your dbt project for BigFrames](#setting-up-your-dbt-project-for-bigframes)
  + [Prerequisites](#prerequisites)
  + [Sample `profiles.yml` for BigFrames](#sample-profilesyml-for-bigframes)
  + [Sample `dbt_project.yml`](#sample-dbt_projectyml)
* [The dbt Python models for linear regression](#the-dbt-python-models-for-linear-regression)
  + [Part 1: Preparing the table (`prepare_table.py`)](#part-1-preparing-the-table-prepare_tablepy)
  + [Part 2: Training the model and making predictions (`prediction.py`)](#part-2-training-the-model-and-making-predictions-predictionpy)
* [Running your dbt ML pipeline](#running-your-dbt-ml-pipeline)
* [Key advantages of dbt and BigFrames for ML](#key-advantages-of-dbt-and-bigframes-for-ml)
