...
About dbt\_version variable | dbt Developer Hub
...
dbt\_project.yml context](/reference/dbt-jinja-functions/dbt-project-yml-context)[Next

debug](/reference/dbt-jinja-functions/debug-method)

* [Example usages[​](#example-usages "Direct link to Example usages")](#example-usages)
