# Source: https://docs.getdbt.com/reference/resource-configs/trino-configs

Starburst/Trino configurations | dbt Developer Hub
...
This materialization supports the [full\_refresh](/reference/resource-configs/full_refresh) config and flag.
...
Snowflake configurations](/reference/resource-configs/snowflake-configs)[Next
...
* [Connector properties](#connector-properties)
  + [Hive catalogs](#hive-catalogs)
* [File format configuration](#file-format-configuration)
* [Seeds and prepared statements](#seeds-and-prepared-statements)
  + [Header line length limit in Python HTTP client](#header-line-length-limit-in-python-http-client)
