# Source: https://docs.getdbt.com/reference/resource-configs/teradata-configs

Teradata configurations | dbt Developer Hub
...
* *Set `quote_columns`* - to prevent a warning, make sure to explicitly set a value for `quote_columns` in your `dbt_project.yml`. See the [doc on quote\_columns](/reference/resource-configs/quote_columns) for more information.
...
Salesforce Data Cloud configurations](/reference/resource-configs/data-cloud-configs)[Next
...
* [valid\_history incremental materialization strategy](#valid_history-incremental-materialization-strategy)
* [Common Teradata-specific tasks](#common-teradata-specific-tasks)
* [The external tables package](#the-external-tables-package)
