# Source: https://docs.getdbt.com/docs/dbt-cloud-apis/discovery-schema-job-exposure

Exposure object schema | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/docs/dbt-cloud-apis/schema-discovery-job-exposure.mdx)

Last updated on **Nov 19, 2025**

[Previous

Tests](/docs/dbt-cloud-apis/discovery-schema-job-tests)[Next
