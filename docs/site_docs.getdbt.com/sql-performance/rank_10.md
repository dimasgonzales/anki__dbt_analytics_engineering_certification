# Source: https://docs.getdbt.com/blog/scaling-data-pipelines-fintech

Scaling Data Pipelines for a Growth-Stage Fintech with Incremental Models | dbt Developer Blog
...
[dbt Docs](/ "dbt Docs")[Developer Blog](/blog "Blog")[Scaling Data Pipelines for a Growth-Stage Fintech with Incremental Models](# "Scaling Data Pipelines for a Growth-Stage Fintech with Incremental Models")
...
[![Adedamola Onabanjo](/img/blog/adedamola-onabanjo.png)](/blog/authors/adedamola-onabanjo)

[Adedamola Onabanjo](/blog/authors/adedamola-onabanjo)
...
| transaction\_id | customer\_id | transaction\_date | amount | status |
| --- | --- | --- | --- | --- |
...
| transaction\_date | transaction\_id | customer\_id | amount | status |
| --- | --- | --- | --- | --- |
...
| date | transactions\_count | total\_amount |
| --- | --- | --- |
...
* [dbt Cloud](/blog/tags/dbt-cloud)
* [fintech](/blog/tags/fintech)
* [BigQuery](/blog/tags/big-query)
...
AI Evaluation in dbt](/blog/ai-eval-in-dbt)[Older post

Introducing the dbt MCP Server – Bringing Structured Data to AI Workflows and Agents](/blog/introducing-dbt-mcp-server)

* [Introduction](#introduction)
* [Challenges in Scaling](#challenges-in-scaling)
* [Approach: Incremental Models & Key Strategies](#approach-incremental-models--key-strategies)
  + [Append Strategy](#append-strategy)
  + [Insert Overwrite Strategy](#insert-overwrite-strategy)
  + [Merge Strategy](#merge-strategy)
* [Optimizing Performance and Cost](#optimizing-performance-and-cost)
  + [Real-World Implementation: Kuda Case Study](#real-world-implementation-kuda-case-study)
