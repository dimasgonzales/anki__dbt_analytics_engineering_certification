# Source: https://docs.getdbt.com/blog/redshift-configurations-dbt-model-optimizations

Optimizing dbt Models with Redshift Configurations | dbt Developer Blog
...
[dbt Docs](/ "dbt Docs")[Developer Blog](/blog "Blog")[Optimizing dbt Models with Redshift Configurations](# "Optimizing dbt Models with Redshift Configurations")
...
[![Christine Berger](/img/blog/authors/christine-berger.jpeg)](/blog/authors/christine-berger)

[Christine Berger](/blog/authors/christine-berger)
...
![Source-Data.png](/assets/images/Source-Data-8fe923987d733c9c9e110589459e9fd6.png)
...
![All-Distribution.png](/assets/images/All-Distribution-b8a67c946d22658f98f5e081030a4f22.png)
...
Here's a visualization of the data stored on our nodes:
![Even-Distribution.png](/assets/images/Even-Distribution-a42f4b5f316abbca1f5cf38801d8bf60.png)
...
Here's a visualization of the data stored on our nodes:
![Key-Based-2.png](/assets/images/Key-Based-2-595cb24b43cdc619a282ac5eca611092.png)
...
![All-Joining.gif](/assets/images/All-Joining-5853347fd47d82a40024b1ae8d5ddb98.gif)
...
![Even-Joining.gif](/assets/images/Even-Joining-756287f58188e20a44790ed2f6599eea.gif)
...
![Key-Based-Joining.gif](/assets/images/Key-Based-Joining-ec512ce1fd81e61d2fc74ad6bbe574bc.gif)
...
![Key-Based-Joining-2.png](/assets/images/Key-Based-Joining-2-07919fd7b5ad5135529cd0e26a579267.png)

We have a few options:

* **Distribute by `all`**  
  But if it’s a table that updates frequently, this may not be the best route.
  ![Key-Based-All.gif](/assets/images/Key-Based-All-97159d1fff662958dd274fad97fae13b.gif)
* **Distribute by `even`**  
  ...
  ![Key-Based-Even.gif](/assets/images/Key-Based-Even-333847895cc3b07d72c50033a1c6f5f0.gif)
* **Distribute by key**  
...
![Staggered-Joins.png](/assets/images/Staggered-Joins-62040b45159a02e28a698b01224f494a.jpg)
...
![Resolve-to-single-key](/assets/images/Resolve-to-single-key-1911a9d1b47e1c1a33e358158fc4718d.jpg)
...
![Sorting.gif](/assets/images/Sorting-84ff360f7f7c624e026ef7ef2ee48388.gif)
...
![Scanning-Sort.gif](/assets/images/Scanning-Sort-0d9ea701a28e261fcdbd45094ae598b8.gif)
...
A star (generator) is born](/blog/star-sql-love-letter)[Older post

Stakeholder-friendly model names: Model naming conventions that give context](/blog/stakeholder-friendly-model-names)

* [The Redshift cluster](#the-redshift-cluster)
* [What are distribution styles?](#what-are-distribution-styles)
  + [The `all` distribution style](#the-all-distribution-style)
  + [The `even` distribution style](#the-even-distribution-style)
  + [The key-based distribution style](#the-key-based-distribution-style)
  + [Things to keep in mind when working with these configurations](#things-to-keep-in-mind-when-working-with-these-configurations)
  + [All](#all)
  + [Even](#even)
  + [Key-based](#key-based)
* [Where it breaks down 🚒 🔥 👩🏻‍🚒](#where-it-breaks-down---)
* [How to have your cake and eat it, too 🎂](#how-to-have-your-cake-and-eat-it-too-)
  + [Staggered joins](#staggered-joins)
  + [Resolve to a single key](#resolve-to-a-single-key)
  + [Let Redshift do its thing](#let-redshift-do-its-thing)
  + [Document before tweaking](#document-before-tweaking)
  + [Test removing legacy `dist` styles and sort keys first](#test-removing-legacy-dist-styles-and-sort-keys-first)
  + [Decide whether you you need to optimize at all!](#decide-whether-you-you-need-to-optimize-at-all)
