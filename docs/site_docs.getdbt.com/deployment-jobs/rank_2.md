# Source: https://docs.getdbt.com/docs/deploy/deploy-environments
...
To learn different approaches to managing dbt environments and recommendations for your organization's unique needs, read [dbt environment best practices](/guides/set-up-ci).

Learn more about development vs. deployment environments in [dbt Environments](/docs/dbt-cloud-environments).
...
For customers using the Semantic Layer, the next section of environment settings is the Semantic Layer configurations. [The Semantic Layer setup guide](/docs/use-dbt-semantic-layer/setup-sl) has the most up-to-date setup instructions.
...
Finally, the Staging environment has its own view in [Catalog](/docs/explore/explore-projects), giving you a full view of your prod and pre-prod data.
...
* [Delete a job or environment in dbt](/faqs/Environments/delete-environment-job)
...
Job scheduler](/docs/deploy/job-scheduler)[Next

About continuous integration](/docs/deploy/about-ci)

* [Create a deployment environment](#create-a-deployment-environment)
  + [Set as production environment](#set-as-production-environment)
  + [Semantic Layer](#semantic-layer)
* [Staging environment](#staging-environment)
  + [Git workflow](#git-workflow)
  + [Why use a staging environment](#why-use-a-staging-environment)
  + [Create a Staging environment](#create-a-staging-environment)
* [Deployment connection](#deployment-connection)
