# Source: https://docs.getdbt.com/docs/cloud/cloud-cli-installation

Install dbt CLI | dbt Developer Hub
...
The dbt CLI is available in all [deployment regions](/docs/cloud/about-cloud/access-regions-ip-addresses) and for both multi-tenant and single-tenant accounts.
...
1. Install using the `pip3 install dbt` [pip](/docs/cloud/cloud-cli-installation?install=pip#install-dbt-cloud-cli) command.
...
Configure your local setup](/docs/configure-dbt-extension)[Next
...
* [Install dbt CLI](#install-dbt-cli)
  ...
  + [Install dbt CLI in pip](#install-dbt-cli-in-pip)
* [Update dbt CLI](#update-dbt-cli)
