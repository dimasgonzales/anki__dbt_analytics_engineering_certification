# Source: https://docs.getdbt.com/faqs/Jinja/which-jinja-docs

Which docs should I use when writing Jinja or creating a macro? | dbt Developer Hub
...
* [Frequently asked questions](/docs/faqs)
  ...
  + [Jinja](/category/jinja)
    ...
    - [Compiled sql has a lot of white space](/faqs/Jinja/jinja-whitespace)
    - [Why quote column names in Jinja](/faqs/Jinja/quoting-column-names)
    - [Useful Jinja docs](/faqs/Jinja/which-jinja-docs)
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/faqs/Jinja/which-jinja-docs.md)

Last updated on **Nov 19, 2025**

[Previous

Why quote column names in Jinja](/faqs/Jinja/quoting-column-names)[Next
