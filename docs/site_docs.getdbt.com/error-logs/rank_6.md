...
* Cloud CLI: Only supports dbt `debug` and `dbt debug --connection`. You can also use the [`dbt environment`](/reference/commands/dbt-environment) command to interact with your dbt environment.
...
compile](/reference/commands/compile)[Next

deps](/reference/commands/deps)

* [Flags[​](#flags "Direct link to Flags")](#flags)
* [Example usage[​](#example-usage "Direct link to Example usage")](#example-usage)
