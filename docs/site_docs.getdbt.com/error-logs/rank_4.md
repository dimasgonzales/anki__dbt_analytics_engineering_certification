...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/dbt-jinja-functions/log.md)

Last updated on **Nov 19, 2025**

[Previous

local\_md5](/reference/dbt-jinja-functions/local_md5)[Next
