...
severity, error\_if, and warn\_if | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/resource-configs/severity.md)

Last updated on **Nov 19, 2025**

[Previous

limit](/reference/resource-configs/limit)[Next
