...
dbt Core 1.6 introduced first-class support for **deprecating models** by specifying a [`deprecation_date`](/reference/resource-properties/deprecation_date). Taken together, model versions and deprecation offer a pathway for model producers to *sunset* old models, and consumers the time to *migrate* across breaking changes. It's a way of managing change across an organization: develop a new version, bump the latest, slate the old version for deprecation, update downstream references, and then remove the old version.
...
Model contracts](/docs/mesh/govern/model-contracts)[Next

Project dependencies](/docs/mesh/govern/project-dependencies)

* [Related documentation](#related-documentation)
* [Why version a model?](#why-version-a-model)
* [When should you version a model?](#when-should-you-version-a-model)
* [How is this different from "version control"?](#how-is-this-different-from-version-control)
* [How is this different from just creating a new model?](#how-is-this-different-from-just-creating-a-new-model)
* [How to create a new version of a model](#how-to-create-a-new-version-of-a-model)
  ...
  + [Configuring database location with `alias`](#configuring-database-location-with-alias)
  + [Run a model with multiple versions](#run-a-model-with-multiple-versions)
  + [Optimizing model versions](#optimizing-model-versions)
