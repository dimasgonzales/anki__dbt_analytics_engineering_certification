# Source: https://docs.getdbt.com/reference/events-logging
...
When [invoking dbt programmatically](/reference/programmatic-invocations#registering-callbacks), it is possible to register a callback on dbt's `EventManager`. This allows access to structured events as Python objects, to enable custom logging and integration with other systems.
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/events-logging.md)

Last updated on **Nov 19, 2025**

[Previous

Warnings](/reference/global-configs/warnings)[Next

Exit codes](/reference/exit-codes)

* [Structured logging](#structured-logging)
  + [`info` fields](#info-fields)
  + [`node_info` fields](#node_info-fields)
  + [Example](#example)
