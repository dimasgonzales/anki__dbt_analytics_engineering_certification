# Source: https://docs.getdbt.com/faqs/Seeds/seed-datatypes

How do I set a datatype for a column in my seed? | dbt Developer Hub
...
* [Frequently asked questions](/docs/faqs)
* [Seeds](/category/seeds)
* Set a datatype for a column in seed
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/faqs/Seeds/seed-datatypes.md)

Last updated on **Nov 19, 2025**

[Previous

Build seeds in a schema outside target schema](/faqs/Seeds/seed-custom-schemas)[Next
