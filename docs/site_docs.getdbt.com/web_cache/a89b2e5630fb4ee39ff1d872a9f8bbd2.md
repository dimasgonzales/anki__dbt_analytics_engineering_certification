# Source: https://docs.getdbt.com/reference/resource-properties/unit-testing-versions
...
* [Resource configs and properties](/reference/resource-configs/resource-path)
  ...
  + [For unit tests](/reference/resource-properties/unit-tests)
    ...
    - [Unit tests](/reference/resource-properties/unit-tests)
    - [Input](/reference/resource-properties/unit-test-input)
    - [Data formats](/reference/resource-properties/data-formats)
    - [Data types](/reference/resource-properties/data-types)
    - [Versions](/reference/resource-properties/unit-testing-versions)
    - [Overrides](/reference/resource-properties/unit-test-overrides)
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/resource-properties/unit-testing-versions.md)

Last updated on **Nov 19, 2025**

[Previous

Data types](/reference/resource-properties/data-types)[Next
