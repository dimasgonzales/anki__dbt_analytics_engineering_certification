# Source: https://docs.getdbt.com/guides/azure-synapse-analytics

Quickstart for dbt and Azure Synapse Analytics | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/guides/azure-synapse-analytics-qs.md)
