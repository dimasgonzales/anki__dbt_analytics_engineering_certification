...
The [Semantic Layer](/docs/use-dbt-semantic-layer/dbt-sl) is a dbt offering that allows users to centrally define their metrics within their dbt project using [MetricFlow](/docs/build/about-metricflow).
...
MetricFlow is hosted in dbt. Requests from the [Semantic Layer APIs](/docs/dbt-cloud-apis/sl-api-overview) are routed from our API gateway to MetricFlow, which generates the SQL to compute what's requested by the user. MetricFlow hands the SQL back to our gateway, which then executes it against the data platform.
...
3. Once you've defined your metrics and semantic models, you can [configure the dbt Semantic Layer](/docs/use-dbt-semantic-layer/setup-sl) in dbt.
...
Consume your metrics](/docs/use-dbt-semantic-layer/consume-metrics)

* [Overview of the dbt Semantic Layer](#overview-of-the-dbt-semantic-layer)
* [Availability](#availability)
* [How does the dbt Semantic Layer work?](#how-does-the-dbt-semantic-layer-work)
* [Build metrics and semantic models](#build-metrics-and-semantic-models)
