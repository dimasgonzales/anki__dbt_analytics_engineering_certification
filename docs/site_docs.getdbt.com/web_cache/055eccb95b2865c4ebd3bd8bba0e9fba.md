# Source: https://docs.getdbt.com/docs/deploy/hybrid-projects

About Hybrid projects | dbt Developer Hub
...
* [Deploy dbt](/docs/deploy/deployments)
  ...
  + [Hybrid projects](/docs/deploy/hybrid-projects)
    ...
    - [About hybrid projects](/docs/deploy/hybrid-projects)
    - [Hybrid setup](/docs/deploy/hybrid-setup)
...
* [Configured](/docs/deploy/hybrid-setup#connect-project-in-dbt-cloud) a hybrid project in dbt.
...
Webhooks](/docs/deploy/webhooks)[Next
