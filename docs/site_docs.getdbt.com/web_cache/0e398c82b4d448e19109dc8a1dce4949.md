...
How we style our SQL | dbt Developer Hub
...
☁️ dbt users can use the built-in [SQLFluff Studio IDE integration](/docs/cloud/dbt-cloud-ide/lint-format) to automatically lint and format their SQL. The default style sheet is based on dbt Labs style as outlined in this guide, but you can customize this to fit your needs. No need to setup any external tools, just hit `Lint`! Also, the more opinionated [sqlfmt](http://sqlfmt.com/) formatter is also available if you prefer that style.
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/best-practices/how-we-style/2-how-we-style-our-sql.md)

Last updated on **Nov 19, 2025**

[Previous

How we style our dbt models](/best-practices/how-we-style/1-how-we-style-our-dbt-models)[Next

How we style our Python](/best-practices/how-we-style/3-how-we-style-our-python)

* [Basics[​](#basics "Direct link to Basics")](#basics)
* [Fields, aggregations, and grouping[​](#fields-aggregations-and-grouping "Direct link to Fields, aggregations, and grouping")](#fields-aggregations-and-grouping)
* [Joins[​](#joins "Direct link to Joins")](#joins)
* ['Import' CTEs[​](#import-ctes "Direct link to 'Import' CTEs")](#import-ctes)
* ['Functional' CTEs[​](#functional-ctes "Direct link to 'Functional' CTEs")](#functional-ctes)
* [Model configuration[​](#model-configuration "Direct link to Model configuration")](#model-configuration)
* [Example SQL[​](#example-sql "Direct link to Example SQL")](#example-sql)
  + [Example SQL[​](#example-sql-1 "Direct link to Example SQL")](#example-sql-1)
