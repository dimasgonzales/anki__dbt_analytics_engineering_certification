# Source: https://docs.getdbt.com/blog/polyglot-dbt-python-dataframes-sql

Stronger together: Python, dataframes, and SQL | dbt Developer Blog
...
[dbt Docs](/ "dbt Docs")[Developer Blog](/blog "Blog")[Stronger together: Python, dataframes, and SQL](# "Stronger together: Python, dataframes, and SQL")
...
Polyglot dbt: An alloy of Python, dataframes, and SQL[​](#polyglot-dbt-an-alloy-of-python-dataframes-and-sql "Direct link to Polyglot dbt: An alloy of Python, dataframes, and SQL")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Trade-offs between SQL and dataframe syntax[​](#trade-offs-between-sql-and-dataframe-syntax "Direct link to Trade-offs between SQL and dataframe syntax")
---------------------------------------------------------------------------------------------------------------------------------------------------------

Once you’re set up - the next question is: what *should* you use Python for? How should you think about tradeoffs between SQL vs. dataframes? I haven’t personally pondered this deeply… but the folks at [Ponder](https://ponder.io/) have 😉 They published a series of posts comparing the two in terms of:
...
Comparing dataframe libraries[​](#comparing-dataframe-libraries "Direct link to Comparing dataframe libraries")
---------------------------------------------------------------------------------------------------------------
...
First hands-on experience using a Python package[​](#first-hands-on-experience-using-a-python-package "Direct link to First hands-on experience using a Python package")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Components of the dbt project[​](#components-of-the-dbt-project "Direct link to Components of the dbt project")
...
#### The dbt Python model[​](#the-dbt-python-model "Direct link to The dbt Python model")
...
#### Testing the result[​](#testing-the-result "Direct link to Testing the result")
...
### Download the repository and install requirements[​](#download-the-repository-and-install-requirements "Direct link to Download the repository and install requirements")
...
### Build it[​](#build-it "Direct link to Build it")
...
### Query the result of the dbt transformation[​](#query-the-result-of-the-dbt-transformation "Direct link to Query the result of the dbt transformation")
...
| id | transaction\_time | parsed\_transaction\_time |
| --- | --- | --- |
...
Best practice recommendations[​](#best-practice-recommendations "Direct link to Best practice recommendations")
---------------------------------------------------------------------------------------------------------------
...
### ❌ **Don’t**:[​](#-dont "Direct link to -dont")
...
### 🤷 We don’t know yet![​](#-we-dont-know-yet "Direct link to 🤷 We don’t know yet!")
...
Demystifying event streams: Transforming events into tables with dbt](/blog/demystifying-event-streams)[Older post

Analysts make the best analytics engineers](/blog/analysts-make-the-best-aes)

* [Polyglot dbt: An alloy of Python, dataframes, and SQL](#polyglot-dbt-an-alloy-of-python-dataframes-and-sql)
* [Trade-offs between SQL and dataframe syntax](#trade-offs-between-sql-and-dataframe-syntax)
* [Comparing dataframe libraries](#comparing-dataframe-libraries)
* [First hands-on experience using a Python package](#first-hands-on-experience-using-a-python-package)
  + [Components of the dbt project](#components-of-the-dbt-project)
  + [Download the repository and install requirements](#download-the-repository-and-install-requirements)
  + [Build it](#build-it)
  + [Query the result of the dbt transformation](#query-the-result-of-the-dbt-transformation)
