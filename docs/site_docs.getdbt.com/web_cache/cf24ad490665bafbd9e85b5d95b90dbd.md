# Source: https://docs.getdbt.com/reference/resource-configs/materialized

materialized | dbt Developer Hub
...
lookback](/reference/resource-configs/lookback)[Next

model\_name](/reference/resource-properties/model_name)

* [Definition](#definition)
* [Creation Precedence](#creation-precedence)
