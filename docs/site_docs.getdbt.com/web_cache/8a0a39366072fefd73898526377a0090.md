...
dbt supports private packages from [supported](#prerequisites) Git repos leveraging an existing [configuration](/docs/cloud/git/git-configuration-in-dbt-cloud) in your environment. Previously, you had to configure a [token](#git-token-method) to retrieve packages from your private repos.
...
If you're using the dbt platform, the SSH key method will not work, but you can use the [HTTPS Git Token Method](/docs/build/packages#git-token-method).

### Git token method[​](#git-token-method "Direct link to Git token method")

note

dbt has [native support](#native-private-packages) for Git hosted private packages with GitHub and Azure DevOps (GitLab coming soon). If you are using a supported [integrated Git environment](/docs/cloud/git/git-configuration-in-dbt-cloud), you no longer need to configure Git tokens to retrieve private packages.
...
Running [`dbt deps`](/reference/commands/deps) "pins" each package by creating or updating the `package-lock.yml` file in the *project\_root* where `packages.yml` is recorded.
...
Hooks and operations](/docs/build/hooks-operations)[Next

Project variables](/docs/build/project-variables)

* [Use cases](#use-cases)
* [How do I create a package?](#how-do-i-create-a-package)
* [How do I add a package to my project?](#how-do-i-add-a-package-to-my-project)
* [How do I specify a package?](#how-do-i-specify-a-package)
  + [Hub packages (recommended)](#hub-packages-recommended)
  + [Git packages](#git-packages)
  + [Internally hosted tarball URL](#internally-hosted-tarball-url)
* [Private packages](#private-packages)
  + [Native private packages](#native-private-packages-)
  + [SSH key method (command line only)](#ssh-key-method-command-line-only)
  + [Git token method](#git-token-method)
* [Configure subdirectory for packaged projects](#configure-subdirectory-for-packaged-projects)
  + [Local packages](#local-packages)
* [What packages are available?](#what-packages-are-available)
* [Advanced package configuration](#advanced-package-configuration)
  + [Updating a package](#updating-a-package)
  + [Uninstalling a package](#uninstalling-a-package)
  + [Pinning packages](#pinning-packages)
  + [Configuring packages](#configuring-packages)
  + [Specifying unpinned Git packages](#specifying-unpinned-git-packages)
