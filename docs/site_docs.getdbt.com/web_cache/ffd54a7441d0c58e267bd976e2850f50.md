...
SQL models](/docs/build/sql-models)[Next

Data tests](/docs/build/data-tests)

* [Overview](#overview)
  + [What is a Python model?](#what-is-a-python-model)
  + [Defining a Python model](#defining-a-python-model)
  + [Referencing other models](#referencing-other-models)
* [Configuring Python models](#configuring-python-models)
  + [Materializations](#materializations)
* [Python-specific functionality](#python-specific-functionality)
  + [Defining functions](#defining-functions)
  + [Using PyPI packages](#using-pypi-packages)
  + [DataFrame API and syntax](#dataframe-api-and-syntax)
