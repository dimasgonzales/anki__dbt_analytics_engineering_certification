# Source: https://docs.getdbt.com/reference/resource-properties/identifier

identifier | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/resource-properties/identifier.md)

Last updated on **Nov 19, 2025**

[Previous

freshness](/reference/resource-properties/freshness)[Next
...
* [Default](#default)
* [Examples](#examples)
  + [Use a simpler name for a source table than the one in your database](#use-a-simpler-name-for-a-source-table-than-the-one-in-your-database)
  + [Reference sharded tables as a source in BigQuery](#reference-sharded-tables-as-a-source-in-bigquery)
