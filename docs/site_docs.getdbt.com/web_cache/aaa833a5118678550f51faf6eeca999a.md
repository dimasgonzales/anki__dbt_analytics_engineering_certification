...
User-defined functions](/docs/build/udfs)[Next
...
* [Using sources](#using-sources)
  ...
  + [Selecting from a source](#selecting-from-a-source)
  + [Testing and documenting sources](#testing-and-documenting-sources)
  + [FAQs](#faqs)
* [Source data freshness](#source-data-freshness)
  + [Declaring source freshness](#declaring-source-freshness)
  + [Checking source freshness](#checking-source-freshness)
  + [Build models based on source freshness](#build-models-based-on-source-freshness)
  + [Filter](#filter)
  + [FAQs](#faqs-1)
