# Source: https://docs.getdbt.com/guides/starburst-galaxy

Quickstart for dbt and Starburst Galaxy | dbt Developer Hub
...
* 1 Introduction​
* 2 Load data to an Amazon S3 bucket​
* 3 Connect Starburst Galaxy to the Amazon S3 bucket​
* 4 Create tables with Starburst Galaxy​
* 5 Connect dbt to Starburst Galaxy​
* 6 Set up a dbt managed repository​
...
* 15 Deploy dbt​
* 16 Connect to multiple data sources​
...
* You have a [multi-tenant](/docs/cloud/about-cloud/access-regions-ip-addresses) deployment in [dbt](https://www.getdbt.com/signup/). For more information, refer to [Tenancy](/docs/cloud/about-cloud/tenancy).
...
* [dbt CI job](/docs/deploy/continuous-integration)
...
5. In another browser tab, log in to [dbt](/docs/cloud/about-cloud/access-regions-ip-addresses).
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/guides/starburst-galaxy-qs.md)
