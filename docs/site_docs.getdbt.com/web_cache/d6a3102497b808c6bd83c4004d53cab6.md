# Source: https://docs.getdbt.com/reference/resource-configs/athena-configs

Amazon Athena configurations | dbt Developer Hub
...
Refer to [persist\_docs](/reference/resource-configs/persist_docs) for more details.
...
Microsoft Azure Synapse DWH configurations](/reference/resource-configs/azuresynapse-configs)[Next
...
* [Models](#models)
  ...
  + [Iceberg](#iceberg)
  + [High availability (HA) table](#high-availability-ha-table)
  + [HA known issues](#ha-known-issues)
  + [Avoid deleting parquet files](#avoid-deleting-parquet-files)
