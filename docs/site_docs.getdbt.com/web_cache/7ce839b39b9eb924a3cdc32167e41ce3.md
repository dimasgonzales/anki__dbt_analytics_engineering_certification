# Source: https://docs.getdbt.com/faqs/Tests/custom-test-thresholds

Can I set test failure thresholds? | dbt Developer Hub
...
* [Frequently asked questions](/docs/faqs)
* [Tests](/category/tests)
* How to set failure thresholds in test
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/faqs/Tests/custom-test-thresholds.md)

Last updated on **Nov 19, 2025**

[Previous

How to name data tests directory](/faqs/Tests/configurable-data-test-path)[Next
