...
About dbt parse command | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/reference/commands/parse.md)

Last updated on **Nov 19, 2025**

[Previous

ls (list)](/reference/commands/list)[Next
