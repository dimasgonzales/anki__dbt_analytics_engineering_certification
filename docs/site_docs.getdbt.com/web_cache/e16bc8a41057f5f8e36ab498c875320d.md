Semantic manifest | dbt Developer Hub
...
**Produced by:** Any command that parses your project. This includes all commands *except* [`deps`](/reference/commands/deps), [`clean`](/reference/commands/clean), [`debug`](/reference/commands/debug), and [`init`](/reference/commands/init).
