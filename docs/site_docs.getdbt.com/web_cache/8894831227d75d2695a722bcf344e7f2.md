# Source: https://docs.getdbt.com/guides/optimize-dbt-models-on-databricks

Optimize and troubleshoot dbt models on Databricks | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/guides/dbt-models-on-databricks.md)
