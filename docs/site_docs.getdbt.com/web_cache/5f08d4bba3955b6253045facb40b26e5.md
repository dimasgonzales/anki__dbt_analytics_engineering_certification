# Source: https://docs.getdbt.com/reference/source-properties

Source properties | dbt Developer Hub
...
Overrides](/reference/resource-properties/unit-test-overrides)[Next
