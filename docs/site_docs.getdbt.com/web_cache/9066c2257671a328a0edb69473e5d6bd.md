...
Available materializations | dbt Developer Hub
...
Materializations best practices](/best-practices/materializations/1-guide-overview)[Next
...
* [Comparing the materialization types](#comparing-the-materialization-types)
