...
Debug errors | dbt Developer Hub
...
* Receiving an `authentication has expired` error when trying to run queries in the IDE.
  ...
  If you see a `authentication has expired` error when you try to run queries in the Studio IDE, this means your [OAuth](/docs/cloud/manage-access/set-up-snowflake-oauth) connection between Snowflake and dbt has expired.
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/guides/debug-errors.md)
