...
Apache Spark configurations](/reference/resource-configs/spark-configs)[Next

ClickHouse configurations](/reference/resource-configs/clickhouse-configs)

* [Use `project` and `dataset` in configurations](#use-project-and-dataset-in-configurations)
* [Using table partitioning and clustering](#using-table-partitioning-and-clustering)
  + [Partition clause](#partition-clause)
  + [Clustering clause](#clustering-clause)
* [Managing KMS encryption](#managing-kms-encryption)
  + [Using KMS encryption](#using-kms-encryption)
* [Labels and tags](#labels-and-tags)
  + [Specifying labels](#specifying-labels)
  + [Applying labels to jobs](#applying-labels-to-jobs)
  + [Specifying tags](#specifying-tags)
  + [Resource tags](#resource-tags)
  + [Policy tags](#policy-tags)
* [Merge behavior (incremental models)](#merge-behavior-incremental-models)
  + [Performance and cost](#performance-and-cost)
  + [The `merge` strategy](#the-merge-strategy)
  + [The `insert_overwrite` strategy](#the-insert_overwrite-strategy)
* [Controlling table expiration](#controlling-table-expiration)
