# Source: https://docs.getdbt.com/docs/cloud/dbt-cloud-ide/lint-format
...
By default, dbt lints all modified `.sql` files in your project, including snapshots. [Snapshots](/docs/build/snapshots) can be defined in YAML *and* `.sql` files, but their SQL isn't lintable and can cause errors during linting.
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/docs/cloud/dbt-cloud-ide/lint-format.md)

Last updated on **Nov 19, 2025**

[Previous

Git commit signing](/docs/cloud/dbt-cloud-ide/git-commit-signing)[Next

Fix deprecations](/docs/cloud/dbt-cloud-ide/autofix-deprecations)

* [Lint](#lint)
  + [Enable linting](#enable-linting)
  + [Customize linting](#customize-linting)
  + [Configure dbtonic linting rules](#configure-dbtonic-linting-rules)
* [Format](#format)
  + [Format SQL](#format-sql)
  + [Format YAML, Markdown, JSON](#format-yaml-markdown-json)
