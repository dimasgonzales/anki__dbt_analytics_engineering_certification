# Source: https://docs.getdbt.com/docs/dbt-versions/core
...
With dbt, you can get early access to new functionality before it becomes available in dbt Core and without the need of managing your own version upgrades. Refer to the ["Latest" Release Track](/docs/dbt-versions/cloud-release-tracks) setting for details.
...
| [**v1.10**](/docs/dbt-versions/core-upgrade/upgrading-to-v1.10) | Jun 16, 2025 | **Active Support — Jun 15, 2026** |
| [**v1.9**](/docs/dbt-versions/core-upgrade/upgrading-to-v1.9) | Dec 9, 2024 | **Critical — Dec 8, 2025** |
...
| [**v1.6**](/docs/dbt-versions/core-upgrade/Older versions/upgrading-to-v1.6) | Jul 31, 2023 | End of Life ⚠️ |
| [**v1.5**](/docs/dbt-versions/core-upgrade/Older versions/upgrading-to-v1.5) | Apr 27, 2023 | End of Life ⚠️ |
...
| [**v1.2**](/docs/dbt-versions/core-upgrade/Older versions/upgrading-to-v1.2) | Jul 26, 2022 | Deprecated ⛔️ |
| [**v1.1**](/docs/dbt-versions/core-upgrade/Older versions/upgrading-to-v1.1) | Apr 28, 2022 | Deprecated ⛔️ |
| [**v1.0**](/docs/dbt-versions/core-upgrade/Older versions/upgrading-to-v1.0) | Dec 3, 2021 | Deprecated ⛔️ |
| **v0.X** ⛔️ | (Various dates) | Deprecated ⛔️ |

All functionality in dbt Core since the v1.7 release is available in [dbt release tracks](/docs/dbt-versions/cloud-release-tracks), which provide automated upgrades at a cadence appropriate for your team.
...
For customers of dbt: dbt Labs strongly recommends migrating environments on older and unsupported versions to [release tracks](/docs/dbt-versions/cloud-release-tracks) or a supported version. In 2025, dbt Labs will remove the oldest dbt Core versions from availability in dbt platform, starting with v1.0 -- v1.2.

### Further reading[​](#further-reading "Direct link to Further reading")

* To learn how you can use dbt Core versions in dbt, see [Choosing a dbt Core version](/docs/dbt-versions/upgrade-dbt-version-in-cloud).
...
We recommend upgrading to a newer version in [dbt](/docs/dbt-versions/upgrade-dbt-version-in-cloud) or [dbt Core](/docs/core/installation-overview#upgrading-dbt-core) to continue receiving support.
...
* You can use it in dbt. For more on dbt versioning, see [Choosing a dbt version](/docs/dbt-versions/upgrade-dbt-version-in-cloud).
...
* Changes to the Python interface for adapter plugins. These changes are relevant *only* to adapter maintainers, and they will be clearly communicated in documentation and release notes. For more information, refer to [Build, test, document, and promote adapters](/guides/adapter-creation) guide.
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/docs/dbt-versions/core-versions.md)
...
* [Version support prior to v1.0](#version-support-prior-to-v10)
* [EOL version support](#eol-version-support)
* [Current version support](#current-version-support)
  + [Minor versions](#minor-versions)
  + [Ongoing patches](#ongoing-patches)
  + [Future versions](#future-versions)
* [Best practices for upgrading](#best-practices-for-upgrading)
  + [Upgrading to new patch versions](#upgrading-to-new-patch-versions)
  + [Upgrading to new minor versions](#upgrading-to-new-minor-versions)
  + [Trying prereleases](#trying-prereleases)
* [How dbt Core uses semantic versioning](#how-dbt-core-uses-semantic-versioning)
  + [How we version adapter plugins](#how-we-version-adapter-plugins)
