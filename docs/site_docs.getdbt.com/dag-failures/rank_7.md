# Source: https://docs.getdbt.com/guides/databricks

Quickstart for dbt and Databricks | dbt Developer Hub
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/guides/databricks-qs.md)
