# Source: https://docs.getdbt.com/docs/cloud/dbt-cloud-ide/ide-user-interface

IDE user interface | dbt Developer Hub
...
The [Studio IDE](/docs/cloud/dbt-cloud-ide/develop-in-the-cloud) is a tool for developers to effortlessly build, test, run, and version-control their dbt projects, and enhance data governance — all from the convenience of your browser. Use the Studio IDE to compile dbt code into SQL and run it against your database directly -- no command line required!
...
5. **Command bar —** The Command bar, located in the lower left of the Studio IDE, is used to invoke [dbt commands](/reference/dbt-commands). When a command is invoked, the associated logs are shown in the Invocation History Drawer.
6. **Defer to production —** The **Defer to production** toggle allows developers to only build and run and test models they've edited without having to first run and build all the models that come before them (upstream parents). Refer to [Using defer in dbt](/docs/cloud/about-cloud-develop-defer#defer-in-the-dbt-cloud-ide) for more info.
...
[![Click F1 to access the dbt Editor Command Palette menu for editor shortcuts](/img/docs/dbt-cloud/cloud-ide/ide-editor-command-palette-with-save.png?v=2 "Click F1 to access the dbt Editor Command Palette menu for editor shortcuts")](#)Click F1 to access the dbt Editor Command Palette menu for editor shortcuts
...
4. **Lint button** — The **Lint** button runs the [linter](/docs/cloud/dbt-cloud-ide/lint-format) on the active file in the file editor. The linter checks for syntax errors and style issues in your code and displays the results in the **Code quality** tab.
...
6. **Code quality tab** — The Code Quality tab displays the results of the linter on the active file in the File Editor. It allows you to view code errors, provides code quality visibility and management, and displays the SQLFluff version used.
7. **Compiled code tab —** The Compile generates the compiled code when the Compile button is executed. The Compiled code tab displays the compiled SQL code for the active file in the file editor.
...
8. **Lineage tab —** The Lineage tab in the file editor displays the active model's lineage or DAG. By default, it shows two degrees of lineage in both directions (`2+model_name+2`), however, you can change it to +model+ (full DAG). To use the lineage:
...
9. **dbt Copilot** — [dbt Copilot](/docs/cloud/dbt-copilot) is a powerful artificial intelligence engine that can generate documentation, tests, and semantic models for you. [Starter](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")[Enterprise](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")[Enterprise +](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")
...
[![The Command History returns a log and detail of all your dbt invocations.](/img/docs/dbt-cloud/cloud-ide/ide-file-search-with-save.png?v=2 "The Command History returns a log and detail of all your dbt invocations.")](#)The Command History returns a log and detail of all your dbt invocations.
...
[Edit this page](https://github.com/dbt-labs/docs.getdbt.com/edit/current/website/docs/docs/cloud/dbt-cloud-ide/ide-user-interface.md)

Last updated on **Nov 19, 2025**

[Previous

About the IDE](/docs/cloud/dbt-cloud-ide/develop-in-the-cloud)[Next

Keyboard shortcuts](/docs/cloud/dbt-cloud-ide/keyboard-shortcuts)

* [Basic layout](#basic-layout)
* [Editing features](#editing-features)
* [Additional editing features](#additional-editing-features)
* [Console section](#console-section)
* [Invocation history](#invocation-history)
* [Modals and Menus](#modals-and-menus)
